...
co2 = Sensor("8a43b2d7-e8d3-4f3d-b832-7dbf37bf629e", "Smoke Warden 1000", "ElysianTech", "CO2 Sensor", None, "g/m^2")
el_meter = Sensor("a2f8690f-2b3a-43cd-90b8-9deea98b42a7", "Volt Watch Elite", "MysticEnergy Innovations", "Electricity Meter", None, "kWh")
...
humidity = Sensor("3d87e5c0-8716-4b0b-9c67-087eaaed7b45", "Aqua Alert 800", "AetherCorp", "Humidity Sensor", None, "%")
...
temp = Sensor("4d8b1d62-7921-4917-9b70-bbd31f6e2e8e", "SmartTemp 42", "AetherCorp", "Temperature Sensor", None, "°C")
air_quality = Sensor("7c6e35e1-2d8b-4d81-a586-5d01a03bb02c", "AeroGuard Pro", "CelestialSense Technologies", "Air Quality Sensor", None, "g/m^2")
