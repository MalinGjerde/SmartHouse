...
living_room_kitchen = DEMO_HOUSE.register_room(ground_floor, 25.0, "Living Room")
...
co2_sensor = DEMO_HOUSE.register_device(living_room_kitchen,"Smoke Warden 1000","8a43b2d7-e8d3-4f3d-b832-7dbf37bf629e", "ElysianTech", "CO2 sensor", "sensor" )
...
heat_pump = DEMO_HOUSE.register_device(living_room_kitchen, "Thermo Smart 6000", "5e13cabc-5c58-4bb3-82a2-3039e4480a6d", "ElysianTech", "Heat Pump", "actuator", )
motion_sensor = DEMO_HOUSE.register_device(living_room_kitchen,"MoveZ Detect 69","cd5be4e8-0e6b-4cb5-a21f-819d06cf5fc5", "NebulaGuard Innovations", "Motion Sensor", "sensor" )
